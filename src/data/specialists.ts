...
export const specialists: Specialist[] = [
  ...
  },
  {
    ...
    about:
      "Z dorosłymi pracuję głównie w obszarach depresji, stanów lękowych oraz prokrastynacji. Pomagam też osobom, które zmagają się z chronicznym stresem, wypaleniem zawodowym, kryzysami życiowymi czy dolegliwościami psychosomatycznymi – kiedy ciało zaczyna chorować od nadmiaru emocji.\n\nZ nastolatkami pracuję integratywnie. Łączę nurt poznawczo-behawioralny (CBT) z ujęciem systemowym, co pozwala nam spojrzeć na młodego człowieka nie w izolacji, ale w kontekście całego jego otoczenia i relacji rodzinnych.\n\nZ dziećmi buduję relację w oparciu o terapię zabawą oraz empatię płynącą z NVC (Porozumienie Bez Przemocy). Pomagam najmłodszym rozumieć ich wielkie emocje w sposób, który jest dla nich najbardziej naturalny.\n\nJestem też prowadzącą warsztatów dla kobiet „Wyregulowana”. To projekt, który zrodził się z mojej fascynacji neurobiologią i somatyką – oraz z czystej potrzeby stworzenia dla kobiet azylu, w którym mogą w końcu zrzucić z barków codzienny ciężar i odetchnąć.\n\nBez względu na to, czy spotkamy się na indywidualnej konsultacji w gabinecie, czy położysz się obok mnie na macie podczas warsztatów – chcę, żebyś wiedziała jedno: jesteś tu bezpieczna. Z całą swoją złością, lękiem, zmęczeniem czy bezsilnością.",
    specializations: [
      "Psychoedukacja",
