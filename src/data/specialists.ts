...
> = {
  ...
  dzieci: { label: "PSYCHOLOG DZIECI I MŁODZIEŻY I DOROSŁYCH", space: "mind" },
...
export const specialists: Specialist[] = [
  {
    ...
    pricing: [
      { name: "Konsultacja psychiatryczna pierwszorazowa", price: "250 zł – 300 zł", duration: "" },
      { name: "Konsultacja kontrolna", price: "200 zł – 250 zł", duration: "" },
      { name: "Konsultacja receptowa", price: "100 zł", duration: "" },
  ...
  },
  {
    ...
    about:
      "​Jestem psychologiem, pedagogiem, socjoterapeutką i trenerką mindfulness. W swojej pracy nie oceniam i nie stawiam dystansu. Jestem po to, aby stworzyć dla Ciebie przestrzeń, w której możesz poczuć się bezpiecznie – ze wszystkim, co akurat przeżywasz.\n\nW moim gabinecie pracuję z dziećmi, młodzieżą oraz osobami dorosłymi:\n\nZ dorosłymi pracuję głównie w obszarach depresji, stanów lękowych, oraz przewlekłego napięcia emocjonalnego. Pomagam odzyskać spokój, kiedy codzienne przytłoczenie lub obniżony nastrój zaczynają odbierać siły.\n\nZ nastolatkami pracuję integratywnie, łącząc nurt poznawczo-behawioralny (CBT) z ujęciem systemowym. Pozwala nam to przyjrzeć się emocjom młodego człowieka przez pryzmat jego relacji z rówieśnikami i domem rodzinnym.\n\nZ dziećmi buduję relację opartą na terapii zabawą oraz języku empatii NVC, pomagając najmłodszym oswajać ich wielkie emocje.\n\nJestem również twórczynią i prowadzącą warsztatów dla kobiet „Wyregulowana”.\n\nTo spotkania dedykowane kobietom, które na co dzień zmagają się z głębokim napięciem emocjonalnym, stresem, a także tym, które przechodzą przez trudny czas depresji. Warsztaty oparłam na elementach MBCT (Terapii Poznawczej Opartej na Uważności).",
    specializations: [
      "Psychoedukacja",
    ...
    pricing: [
      ...
      { name: "Warsztat wyregulowana", price: "70zł", duration: "50 min spotkanie grupowe" },
    ],
  },
  {
